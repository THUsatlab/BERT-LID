...
def get_args(data_dir, output_dir, cache_dir, bert_vocab_file, bert_model_dir, log_dir):
    ...
    parser.add_argument("--model_name", default="BertDPCNN",
                        type=str, help="the name of model ")
    parser.add_argument("--save_name", default="BertDPCNN",
    ...
    parser.add_argument("--output_dir",
                        default=output_dir + "BertDPCNN/",
                        type=str,
                        help="The output directory where the model predictions and checkpoints will be written.")

    parser.add_argument("--cache_dir",
                        default=cache_dir + "BertDPCNN/",
                        type=str,
                        help="缓存目录，主要用于模型缓存")

    parser.add_argument("--log_dir",
                        default=log_dir + "BertDPCNN/",
                        type=str,
